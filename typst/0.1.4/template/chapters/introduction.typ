#let introduction() = [
  ...
  Since we are operating in the switch, the focus is on network-layer parameters instead of application layers, with QoE estimated from buffering-related events (e.g., stalling and depletion).
